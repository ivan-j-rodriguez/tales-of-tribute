...
export const OFFICIAL_PATRON_TEXT = {
  treasury: {
    favored: null,
    neutral: 'Pay 2 Coin and sacrifice 1 card from hand or played cards: create Writ of Coin in cooldown.',
    unfavored: null,
  },
  pelin: {
    favored: 'Pay 2 Power with an agent in cooldown: refresh up to 1 agent.',
    neutral: 'Pay 2 Power with an agent in cooldown: refresh up to 1 agent; this Patron favors you.',
    unfavored: 'Pay 2 Power with an agent in cooldown: refresh up to 1 agent; this Patron becomes Neutral.',
  },
  hlaalu: {
    favored: 'Sacrifice one owned in-play card costing at least 1 Coin: gain Prestige equal to its cost minus 1.',
    neutral: 'Sacrifice one owned in-play card costing at least 1 Coin: gain Prestige equal to its cost minus 1; this Patron favors you.',
    unfavored: 'Sacrifice one owned in-play card costing at least 1 Coin: gain Prestige equal to its cost minus 1; this Patron becomes Neutral.',
  },
  crows: {
    favored: 'Unusable; no benefit.',
    neutral: 'Pay all Coin: gain Power equal to Coin paid minus 1; this Patron favors you.',
    unfavored: 'Pay all Coin: gain Power equal to Coin paid minus 1; this Patron becomes Neutral.',
  },
  celarus: {
    favored: 'If opponent has an active agent, pay 4 Coin: knock it out.',
    neutral: 'If opponent has an active agent, pay 4 Coin: knock it out; this Patron favors you.',
    unfavored: 'If opponent has an active agent, pay 4 Coin: knock it out; this Patron becomes Neutral.',
  },
  hunding: {
    favored: 'If you hold this favor until the start of your turn, gain 1 Coin.',
    neutral: 'Pay 2 Power: gain 1 Coin; this Patron favors you.',
    unfavored: 'Pay 2 Power: gain 1 Coin; this Patron becomes Neutral.',
  },
  redeagle: {
    favored: 'Pay 2 Power: draw 1.',
    neutral: 'Pay 2 Power: draw 1; this Patron favors you.',
    unfavored: 'Pay 2 Power: draw 1; this Patron becomes Neutral.',
  },
  orgnum: {
    favored: 'Pay 3 Coin: gain 1 Power per 4 owned cards; create Summerset Sacking.',
    neutral: 'Pay 2 Coin: gain 1 Power per 6 owned cards; this Patron favors you.',
    unfavored: 'Pay 1 Coin: gain 2 Power; this Patron becomes Neutral.',
  },
  rajhin: {
    favored: 'Pay 3 Coin: create Bewilderment in opponent cooldown.',
    neutral: 'Pay 3 Coin: create Bewilderment in opponent cooldown; this Patron favors you.',
    unfavored: 'Pay 3 Coin: create Bewilderment in opponent cooldown; this Patron becomes Neutral.',
  },
  druid: {
    favored: 'Passive Combo 4: add The Chimera to your cooldown. Also pay 2 Power to replace up to 2 Tavern cards.',
    neutral: 'Passive Combo 5: add The Chimera to your cooldown. Also pay 2 Power to replace up to 2 Tavern cards; this Patron favors you.',
    unfavored: 'Pay 2 Power: replace up to 2 Tavern cards; this Patron becomes Neutral.',
  },
  almalexia: {
    favored: 'Pay 1 Coin and discard a card: Reprieve 5.',
    neutral: 'Discard a card: Reprieve 4; this Patron favors you.',
    unfavored: 'Pay 1 Coin: Reprieve 3; this Patron becomes Neutral.',
  },
  mora: {
    favored: 'Pay 3 Power: Bargain.',
    neutral: 'Pay 3 Power: Bargain; this Patron favors you.',
    unfavored: 'Pay 2 Power: Bargain; this Patron becomes Neutral.',
  },
  alessia: {
    favored: 'Pay 4 Coin: create Chainbreaker Sergeant in cooldown.',
    neutral: 'Pay 4 Coin: create Soldier of the Empire in cooldown; this Patron favors you.',
    unfavored: 'Pay 3 Coin: gain 2 Power; this Patron becomes Neutral.',
  },
};
