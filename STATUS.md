...
**2026-09-15 (build 52):** Board/felt **landscape only**. Modest zoom-out so tavern hexes and the you-hand hexes sit fully on an 844×390 felt. Left opp DRAW / tavern DECK / you DRAW shift right just enough that stack art **and** the words under each are fully on-canvas (safe-area aware). Right COOLDOWNs stay right and fully visible. DECK still left of the tavern at band mid. Portrait packing from build 51 is locked (layout-fb / center / corner / patron rules unchanged). Card backs, Treasury 1:1 circle, gold glow, hold-inspect, and layout-fb overlap gates stay. Club hub / store / collection / economy / music / auth / voice / club-chrome untouched. `?v=52`.
