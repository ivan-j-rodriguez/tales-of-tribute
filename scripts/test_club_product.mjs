...
assert(/build 64/.test(html), 'splash stamp is build 64');
assert(/\?v=64/.test(html), 'cache bust is 64');
...
assert(/build 64/.test(docsHtml) && /\?v=64/.test(docsHtml), 'docs index stamp and cache bust are 64');
