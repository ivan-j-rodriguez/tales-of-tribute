...
assert(/build 60/.test(html), 'splash stamp is build 60');
assert(/\?v=60/.test(html), 'cache bust is 60');
...
assert(/build 60/.test(docsHtml) && /\?v=60/.test(docsHtml), 'docs index stamp and cache bust are 60');
